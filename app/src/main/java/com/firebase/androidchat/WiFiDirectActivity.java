...
public class WiFiDirectActivity extends Activity implements ChannelListener, DeviceActionListener {
    ...
    public static Firebase basededatos;
    ...
    public  final static String lati = "latitud";
...
//se inicia el servicio
       ...
       // mFirebaseRef = new Firebase(FIREBASE_URL).child("chat");
        basededatos = new Firebase( FIREBASE_URL).child("chat");
...
//        mChatListAdapter.cleanup();
    ...
    public  void mostrarAlerta()
    {
        ...
        if (estado.equals("rojo") || estado.equals("Rojo") || estado.equals("ROJO"))
        {
            ...
            System.out.println("esto es lo que se va a guardar" + lng + lat);
            i.putExtra("UNICOLON", String.valueOf(lng));
            i.putExtra("UNICOLAT", String.valueOf(lat));
