...
public class FileTransferService extends IntentService {
    ...
    public static final String ACTION_SEND_FILE = "com.firebase.androidchat.wifidirect.SEND_FILE";
            ...
            try {
                ...
                try {
                   ...
                   /* InputStreamReader arch = new InputStreamReader(
                    ...
                    Log.d(WiFiDirectActivity.TAG, todo + "esto es lo que hay en el archivo al principio");
...
*/
               ...
               DeviceDetailFragment.copyFile(is, stream);
                    PushbackInputStream pus = new PushbackInputStream(is);
                    //System.out.println("el back" + is.read());
                ...
                Log.e(WiFiDirectActivity.TAG, e.getMessage() + "mas aqui");
            } finally {
                if (socket != null) {
